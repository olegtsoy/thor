...
Metrics.prototype.summary = function summary() {
  ...
  table.emitTable({
    columns: [
      { label: '', width: 20 },
      { label: ' 10%', width: width },
      { label: ' 20%', width: width },
      { label: ' 30%', width: width },
      { label: ' 40%', width: width },
      { label: ' 50%', width: width },
      { label: ' 60%', width: width },
      { label: ' 70%', width: width },
    ...
    rows: [
      [
        'Handshaking',
        handshaking.percentile(10).toFixed(),
        handshaking.percentile(20).toFixed(),
        handshaking.percentile(30).toFixed(),
        handshaking.percentile(40).toFixed(),
        handshaking.percentile(50).toFixed(),
        handshaking.percentile(60).toFixed(),
        handshaking.percentile(70).toFixed(),
      ...
      [
        'Latency',
        latency.percentile(10).toFixed(),
        latency.percentile(20).toFixed(),
        latency.percentile(30).toFixed(),
        latency.percentile(40).toFixed(),
        latency.percentile(50).toFixed(),
        latency.percentile(60).toFixed(),
        latency.percentile(70).toFixed(),
